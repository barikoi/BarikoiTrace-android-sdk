...
public class Api {
    public static final String url_base="https://admin.barikoi.xyz:8090/";
    ...
    public static String checkduplicates=url_base+"places/contributors/new/";

    public static String logouturl=base_url+"logout";
    public static final String nearby=url_base+"verification/nearby/place/dtool";
    public static final String deleteurl=url_base+"place/delete/";
